 ...
 const Navbar = () => {
  ...
  return (
    ...
    <Box width="100%" height="80px" bg={useColorModeValue('blue', 'blue.800')} display="flex" justifyContent="space-between">
        ...
        <Input htmlSize={38} width='auto'  placeholder='Search' color="white"/>
            <Button  colorScheme='black'><BsSearch/></Button>
        </div>
        <div style={{width:"30%",display:"flex",alignItems:"center",justifyContent:"space-around"}}>
            <button style={{border:"none",color:"white",cursor:"pointer",display:"flex",alignItems:"center"}}><BsFillCartCheckFill fontSize={30}/><Text color="white" fontWeight="800" fontSize="20">Cart</Text></button>
            ...
            <hr />
        <Box  w='100%' p={3} color='white' boxShadow='xl'>
